...
const AddReview = () => {
   ...
   const onSubmit = async (data) => {
      ...
      const imgFile = { image: data.reviewImg[0] };
      console.log(imgFile);
      ...
      const postRes = await axiosSecure.post("/reviews", reviewInformation);
      ...
      <div>
         ...
         {user ? (
            <div>
               ...
               <section className="bg-white py-4 max-w-screen-2xl mx-auto md:ml-48">
                  <div className="container px-4 mx-auto">
                     <div className="flex flex-wrap -m-3 mb-3">
                        <div className="w-full md:w-3/4 p-3">
                           <form onSubmit={handleSubmit(onSubmit)} className="p-6 h-full overflow-hidden bg-white rounded-md">
                              <div className="flex flex-wrap pb-3 -m-3">
                                 <div className="w-full md:w-1/2 p-3">
                                    <p className="mb-1.5 font-medium text-base text-coolGray-800">First name</p>
                                    <input
                                       {...register("reviewName", { required: true })}
                                       className="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-[#02afe5] border border-coolGray-200 rounded-lg shadow-input"
                                       type="text"
                                 ...
                                 <div className="w-full md:w-1/2 p-3">
                                    ...
                                    <input
                                       {...register("reviewEmail", { required: true })}
                                       className="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-[#02afe5] border border-coolGray-200 rounded-lg shadow-input"
                                       type="text"
                                    ...
                                    <div className="flex flex-wrap">
                                       <div className="w-full">
                                          ...
                                          <textarea
                                             ...
                                             className="block w-full h-64 p-4 text-base text-coolGray-900 font-normal outline-none focus:border-[#02afe5] border border-coolGray-200 rounded-lg shadow-input resize-none"
                                          ></textarea>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div className="flex flex-wrap -m-3">
                                       <div className="w-full p-3">
                                          ...
                                          <div className="relative flex flex-col items-center justify-center mb-6 p-6 h-44 text-center text-[#02afe5] focus-within:border-[#02afe5] border border-dashed border-coolGray-200 rounded-lg">
                                             ...
                                             <input {...register("reviewImg", { required: true })} className="absolute top-0 left-0 w-full h-full opacity-0" type="file" />
                                          </div>
                                          <button
                                             disabled={loading}
                                          ...
                                          >
                                             {loading ? (
                                                ...
                                                <span className="relative z-10 font-pansy text-xl">Save</span>
                                             )}
                                          </button>
                                       </div>
                                    </div>
